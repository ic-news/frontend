...
import { idlFactory } from './ic-news-frontend.did.js';
export { idlFactory } from './ic-news-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IC_NEWS_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic-news-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic-news-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic-news-frontend.did.js")._SERVICE>}
 */
export const ic_news_frontend = createActor(canisterId);
